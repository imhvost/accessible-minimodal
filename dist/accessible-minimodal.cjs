"use strict";var x=Object.defineProperty;var A=(n,t,i)=>t in n?x(n,t,{enumerable:!0,configurable:!0,writable:!0,value:i}):n[t]=i;var p=(n,t,i)=>(A(n,typeof t!="symbol"?t+"":t,i),i);Object.defineProperty(exports,Symbol.toStringTag,{value:"Module"});const $={animationDuration:400,classes:{modal:"modal",wrapp:"modal-wrapp",body:"modal-body",active:"active",open:"open",close:"close"},disableScroll:!0,focus:{use:!0,selectors:["button:not([disabled])","[href]",'input:not([disabled]):not([type="hidden"]):not([aria-hidden])',"select:not([disabled]):not([aria-hidden])","textarea:not([disabled]):not([aria-hidden])",'[tabindex]:not([tabindex="-1"])','[contenteditable="true"]']},hash:{open:!1,add:!1,remove:!1},multiple:{use:!1,closePrevModal:!1},on:{beforeOpen:()=>({}),afterOpen:()=>({}),beforeClose:()=>({}),afterClose:()=>({})},outsideClose:!0,style:{use:!1,width:400,valign:"center",animation:"from-bottom"},triggersAttrs:{open:"data-modal-open",close:"data-modal-close",closeAll:"data-modal-close-all"}},B=n=>{const{modal:t,wrapp:i,body:e,active:s,open:o,close:a}=n.classNames,l=m=>{switch(m){case"top":return"0 auto auto";case"bottom":return"auto auto 0";default:return"auto"}},c=m=>{switch(m){case"from-top":return"translateY( calc(var(--accessible-minimodal-translate) * -1) )";case"from-left":return"translateX( calc(var(--accessible-minimodal-translate) * -1) )";case"from-right":return"translateX(var(--accessible-minimodal-translate))";case"zoom-in":return"scale(.8)";case"zoom-out":return"scale(1.2)";case"fade":return"none";default:return"translateY(var(--accessible-minimodal-translate))"}},d=l(n.margin??""),r=c(n.transform??"");return`
:root{
