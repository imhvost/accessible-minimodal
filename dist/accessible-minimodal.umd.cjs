(function(f,c){typeof exports=="object"&&typeof module<"u"?c(exports):typeof define=="function"&&define.amd?define(["exports"],c):(f=typeof globalThis<"u"?globalThis:f||self,c(f["accessible-minimodal"]={}))})(this,function(f){"use strict";var E=Object.defineProperty;var k=(f,c,p)=>c in f?E(f,c,{enumerable:!0,configurable:!0,writable:!0,value:p}):f[c]=p;var w=(f,c,p)=>(k(f,typeof c!="symbol"?c+"":c,p),p);const c={animationDuration:400,classes:{modal:"modal",wrapp:"modal-wrapp",body:"modal-body",active:"active",open:"open",close:"close"},disableScroll:!0,focus:{use:!0,selectors:["button:not([disabled])","[href]",'input:not([disabled]):not([type="hidden"]):not([aria-hidden])',"select:not([disabled]):not([aria-hidden])","textarea:not([disabled]):not([aria-hidden])",'[tabindex]:not([tabindex="-1"])','[contenteditable="true"]']},hash:{open:!1,add:!1,remove:!1},multiple:{use:!1,closePrevModal:!1},on:{beforeOpen:()=>({}),afterOpen:()=>({}),beforeClose:()=>({}),afterClose:()=>({})},outsideClose:!0,style:{use:!1,width:400,valign:"center",animation:"from-bottom"},triggersAttrs:{open:"data-modal-open",close:"data-modal-close",closeAll:"data-modal-close-all"}},p=h=>{const{modal:e,wrapp:s,body:t,active:i,open:o,close:n}=h.classNames,a=g=>{switch(g){case"top":return"0 auto auto";case"bottom":return"auto auto 0";default:return"auto"}},l=g=>{switch(g){case"from-top":return"translateY( calc(var(--accessible-minimodal-translate) * -1) )";case"from-left":return"translateX( calc(var(--accessible-minimodal-translate) * -1) )";case"from-right":return"translateX(var(--accessible-minimodal-translate))";case"zoom-in":return"scale(.8)";case"zoom-out":return"scale(1.2)";case"fade":return"none";default:return"translateY(var(--accessible-minimodal-translate))"}},r=a(h.margin??""),d=l(h.transform??"");return`
:root{
